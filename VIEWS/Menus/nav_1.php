<div class="btn-group ml-5 mt-1">
   ...
   <button type="button" class="btn bg-primary p-3 text-white "><a href="index.php?action=medicos" class="text-white">Medicos</a></button>
   <button type="button" class="btn bg-primary p-3 text-white "><a href="index.php?action=patologias" class="text-white">Patologias</a></button>
